...
```yaml
- study_type: "CT Coronary Artery Calcium Scoring"
  body_region: "Chest / Coronary Arteries"
  exam_date: "2026-03-20"
  facility: "Regional Cardiovascular Imaging Center"
  indication: "ASCVD risk stratification; post-NSTEMI follow-up; statin therapy monitoring"
  technique: "Non-contrast ECG-gated CT; Agatston scoring method"
  key_findings:
    - "Calcified plaque present in the left anterior descending artery (LAD)"
    - "Mild calcification in the left circumflex artery (LCX)"
    - "No significant calcification in the right coronary artery (RCA)"
    - "No pericardial effusion"
  quantitative_results:
    - name: "Total Agatston CAC Score"
      value: "142"
      units: "Agatston units"
      reference_or_interpretation: "Elevated; age/sex-matched 75th percentile; indicates moderate coronary atherosclerotic burden"
    - name: "LAD Agatston Score"
      value: "118"
      units: "Agatston units"
      reference_or_interpretation: "Predominant vessel involved; consistent with prior LAD stent placement"
    - name: "LCX Agatston Score"
      value: "24"
      units: "Agatston units"
      reference_or_interpretation: "Mild; monitor"
    - name: "RCA Agatston Score"
      value: "0"
      units: "Agatston units"
